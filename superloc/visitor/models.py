...
class Category(models.Model):
    ...
    label = models.CharField('Nom de la catégorie', max_length=30, default='default')
    sample = models.CharField('Modèle principal', max_length=30, default='default')
    image = models.ImageField(upload_to='media/visitor', max_length=300, default='media/visitor')
